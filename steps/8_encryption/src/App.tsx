      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4">
            ...
            <div className="flex">
              ...
              <div className="ml-3 flex-1">
                <p className="text-sm text-blue-700">
                  This is Step 8 (Encryption) of the Waku Chat application. You can now send and receive encrypted messages using both asymmetric (ECIES) and symmetric encryption.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <NodeInfo />
            {isInitialized && <EncryptionToggle />}
          </div>
        </div>
